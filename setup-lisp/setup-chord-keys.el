...
;; (key-seq-define-global "qh" 'find-file-in-project)
;; (key-seq-define-global "q." 'find-file-in-project-by-selected)
(key-seq-define-global "qj" 'find-project)
(key-seq-define-global "qd" 'dired-jump)
